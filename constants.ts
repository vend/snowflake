...
export const tracks: Tracks = {
  ...
  MENTORSHIP: {
    ...
    milestones: [
      ...
      {
        summary:
          "Teaches small groups of engineers and contributes to Vend's shared knowledge base",
        signals: [
  ...
  EVANGELISM: {
    ...
    category: 'D',
    summary:
      'Promotes Vend to the outside world and establishes it as an attractive and thoughtful place to work',
    description:
      'Vend devotes a lot of intentional thought to all its endeavours, whether our technical innovations, the cultural impact of our choices, or how we design our organisation. We strive to create a healthy, balanced, and mindful workplace, build exceptional products, and engage with the outside world in a responsible, inclusive way. We want our people to be communicating these efforts externally, representing Vend well, building partnerships with other organisations, and encouraging people to get to know us more.',
    milestones: [
      {
        summary:
          'Represents Vend well externally, and influences individuals positively',
        signals: [
      ...
      {
        summary:
          'Works hard to positively influence large groups of people on their views of Vend',
        signals: [
      ...
      {
        summary:
          'Establishes Vend as an great, innovative company and workplace to the whole industry',
        signals: [
      ...
      {
        summary:
          'Introduces Vend in a positive light to a wider audience outside the industry',
        signals: [
  ...
  RECRUITING: {
    ...
    milestones: [
      {
        summary:
          'Brings new candidates into the pipeline and/or understands how to evaluate candidates at Vend',
        signals: [
